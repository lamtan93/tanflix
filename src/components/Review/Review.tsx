        ...
        <section className='review'>
            ...
            <div className='review__content'>
                <div className='review__item'>
                    ...
                    <p className='review__paragraph'>J’aime beaucoup l’application Tanflix qui propose beaucoup de choix en therme de séries/films/animés..</p>
                </div>
                <div className='review__item'>
                    <Actor name='Hugo' imgSrc={actor2} isImgSrcLocal/>
                    <p className='review__paragraph'>L’application Tanflix est une bonne application. On y retrouve des produits variés pour tous les goûts.</p>
                </div>
                <div className='review__item'>
                    <Actor name='David' imgSrc={actor3} isImgSrcLocal/>
                    <p className='review__paragraph'>L'application est rodée, efficace et rapide . 4 étoiles pour la technique.</p>
                </div>
                <div className='review__item'>
                    <Actor name='Corgi' imgSrc={actor2} isImgSrcLocal/>
                    <p className='review__paragraph'>Application au top, l'expérience est fluide, logique et super bien pensée.</p>
                </div>
                <div className='review__item'>
                    <Actor name='Tan' imgSrc={actor3} isImgSrcLocal/>
                    <p className='review__paragraph'>J'ai un abonnement Tanflix pour 4 personnes et toute la fimille en profite. Vaut vraiment le coup.</p>
                </div>
                <div className='review__item'>
                    <Actor name='Corgi' imgSrc={actor1} isImgSrcLocal/>
